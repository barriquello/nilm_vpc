...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Reconstruct a 1-dimensional signal from its dost coefficients.
% The dost coefficients are assumed to be a vector of length 2^d.
%
...
% Outputs:
% "reconstructed_signal"  - vector of data whose dost coefficients 
